---
description: Create a changelog entry following established format and style guidelines
---

## Create a changelog

This command creates a new changelog entry following our established format and style guidelines.
